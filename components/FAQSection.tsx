...
const FAQ_DATA: FAQItem[] = [
  {
    ...
    answer: "HackHive is a Hack Club community for teenagers who make things. Software, hardware, games, art, strange prototypes: if you can build it, break it, and learn from it, it belongs here."
  },
  {
